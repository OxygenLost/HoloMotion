...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            # np.savez("/home/maiyue01.chen/project3/whole_body_tracking/data/retargeted/dance1_subject2_sliced-90-615_padded_normalized.npz", **log)
            
            npz_file_path = args_cli.input_file.replace(".csv", ".npz")
            np.savez(npz_file_path, **log)
            
            print(f"[INFO]: Motion saved to {npz_file_path} !")
