...
class PPO:
    ...
    def _init_config(self):
        ...
        self.num_privileged_obs = self.env.config.robot.algo_obs_dim_dict["critic"]
    ...
    def _setup_normalizers(self):
        ...
        # Use local EmpiricalNormalization
    ...
    def update(self):
        ...
        for (
            ...
            if hasattr(self.actor.actor_module, "compute_bound_loss"):
                bound_loss = (
            ...
            if hasattr(self.critic.critic_module, "compute_load_balancing_loss"):
    ...
    def _log(self, locs: dict):
        ...
        if self.ep_infos:
            for key in self.ep_infos[0]:
                ...
                if infotensor.numel() > 0:
                    ...
                    if "/" in key:
                        self.tensorboard_writer.add_scalar(key, value.item(), it)
        ...
        fps = int(
            self.num_steps_per_env * self.num_envs / (collection_time + learn_time)
        )
        ...
        self.tensorboard_writer.add_scalar("Loss/learning_rate", self.learning_rate, it)
        self.tensorboard_writer.add_scalar("Policy/mean_noise_std", mean_std.item(), it)
        self.tensorboard_writer.add_scalar("Perf/total_fps", fps, it)
        self.tensorboard_writer.add_scalar("Perf/collection_time", collection_time, it)
        self.tensorboard_writer.add_scalar("Perf/learning_time", learn_time, it)
    ...
    def save(self, path, infos=None):
        ...
        if self.obs_norm_enabled and hasattr(self, "privileged_obs_normalizer"):
