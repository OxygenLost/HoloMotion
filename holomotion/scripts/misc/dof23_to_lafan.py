...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Convert 23 DOF PKL files back to LAFAN-style CSV format"
    )
    parser.add_argument(
        "--pkl_dir",
        type=str,
        required=True,
        help="Directory containing PKL motion files with 23 DOFs",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        nargs=6,
        default=None,
        help="Default values for 6 wrist DOFs (left_roll, left_pitch, left_yaw, right_roll, right_pitch, right_yaw)",
    )
    ...
    dof23_to_lafan_csv(
        ...
        default_wrist_values=args.wrist_values,
    )
